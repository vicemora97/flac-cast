...
const api: HiresApi = {
  ...
  castQueue: (request) => ipcRenderer.invoke("cast:queue", request),
  updateCastQueue: (request) => ipcRenderer.invoke("cast:queue-update", request),
  updateCastQueueModes: (request) => ipcRenderer.invoke("cast:queue-modes", request),
  castCommand: (command, origin) => ipcRenderer.invoke("cast:command", command, origin),
